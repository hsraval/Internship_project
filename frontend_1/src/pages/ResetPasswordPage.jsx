    ...
    return (
      <div className="min-h-screen bg-[#d7e9f2] flex items-center justify-center px-4 py-24">
        <div className="text-center max-w-sm">
          <p className="font-mono text-xs text-[#80b3ba] uppercase tracking-widest mb-4">Error</p>
          <h2 className="font-display text-2xl font-semibold text-[#16537e] mb-3">Invalid link</h2>
          <p className="font-body text-[#16537e]/70 text-sm mb-6">
    ...
    <div className="min-h-screen bg-[#d7e9f2] flex items-center justify-center px-4 py-24">
      <div className="w-full max-w-md animate-fade-up">
        <div className="text-center mb-8">
          ...
          <p className="font-mono text-xs text-[#80b3ba] uppercase tracking-widest mt-3">
            Choose new password
          </p>
        </div>
        ...
        <div className="auth-card">
          {success ? (
            <div className="text-center py-4">
              ...
              <h2 className="font-display text-xl font-semibold text-[#16537e] mb-2">
                Password updated!
              </h2>
              <p className="font-body text-[#16537e]/70 text-sm">
                Redirecting you to sign in…
              </p>
            </div>
          ) : (
            <>
              <p className="font-body text-[#16537e]/70 text-sm mb-6 leading-relaxed">
          ...
          <div className="mt-6 pt-6 border-t border-[#b0d3e6] text-center">
            <Link
              to="/login"
              className="inline-flex items-center gap-1.5 text-sm font-body text-[#80b3ba] hover:text-[#16537e] transition-colors"
            >
