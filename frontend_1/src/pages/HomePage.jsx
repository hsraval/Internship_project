...
//                 className="block w-full text-left px-5 py-3 text-sm font-mono text-[#333333] hover:bg-[#F2F2F2] transition-colors border-b border-[#E5E5E5]">
//                 Dashboard
//               </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <div className="flex gap-4">
                {['Instagram', 'Facebook', 'Twitter'].map(social => (
                  <a key={social} href="#" className="text-[10px] font-mono uppercase tracking-widest text-[#64748B] hover:text-[#C5A059] transition-colors border border-[#1E293B] rounded-full px-3 py-1.5 hover:border-[#C5A059]/30">
                    {social}
                  </a>
                ))}
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+919876543210" className="text-sm text-[#FFFFFF] hover:text-[#C5A059] transition-colors">
                      +91 98765 43210
                    </a>
                  </div>
                </li>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#FFFFFF] leading-relaxed">
                    ...
                    Fashion Hub, Connaught Place,<br />
                    New Delhi - 110001
                  </p>
                </div>
              </div>
