        ...
        <div className="auth-card">
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="font-body text-[#1e2a3a]/70 text-sm leading-relaxed mb-6">
                We sent a reset link to{' '}
                <span className="font-medium text-[#16537e]">{values.email}</span>.
                It expires in 30 minutes.
              </p>
              <p className="text-xs font-body text-[#1e2a3a]/60">
                Didn't get it?{' '}
                <button
                  onClick={() => setSent(false)}
                  className="text-[#16537e] font-medium hover:underline underline-offset-2"
                >
                  Try again
                </button>
              </p>
