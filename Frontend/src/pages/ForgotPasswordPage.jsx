        ...
        <div className="auth-card">
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="font-body text-ink-500 text-sm leading-relaxed mb-6">
                We sent a reset link to{' '}
                <span className="font-medium text-ink-800">{values.email}</span>.
              ...
              <p className="text-xs font-body text-ink-400">
                ...
                <button
                  ...
                  className="text-ink-700 font-medium hover:underline underline-offset-2"
                >
                  Try again
                </button>
              </p>
