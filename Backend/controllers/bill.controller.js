...
exports.downloadBillPDF = async (req, res, next) => {
    try {
        ...
        doc.fontSize(10)
            ...
            .fillColor('#555')
            .text(
                "Premium Tailoring & Fabric Solutions",
                { align: 'center' }
            );

        doc.text(
            "Ahmedabad, Gujarat | +91 98765 43210",
            { align: 'center' }
        );
        ...
        doc.fontSize(11)
            .font('Helvetica')
            .fillColor('#000')
            .text(bill.user?.name || 'N/A', 50, startY + 18);
        ...
        doc.rect(rightX + 80, startY + 38, 90, 18)
        ...
        doc.rect(summaryX - 10, summaryY, 195, 120)
            .stroke();

        let currentSummaryRowY = summaryY + 15;

        const printSummaryRow = (
            label,
            amount,
            isBold = false,
            isTotal = false
        ...
        doc.moveTo(summaryX, currentSummaryRowY + 2)
            .lineTo(summaryX + 185, currentSummaryRowY + 2)
            .lineWidth(1)
            .strokeColor('#ccc')
            .stroke();
        ...
        // ================= PAYMENT INFO =================
        const paymentSectionY = summaryY + 140;

        doc.rect(50, paymentSectionY, 495, 80)
            .lineWidth(1)
            .strokeColor('#ddd')
            .stroke();
        ...
        if (bill.paymentStatus === 'paid') {
            ...
            doc.fontSize(10)
                ...
                .fillColor('#27ae60')
                .text(
                    `Payment completed successfully on ${new Date(
                        bill.paidAt
                    ).toLocaleDateString()}`,
                    70,
                    paymentSectionY + 45
            ...
            doc.fontSize(10)
                ...
                .fillColor('#555')
                .text(
                    "Payment is pending. Please complete payment from website.",
                    70,
                    paymentSectionY + 45
                );
        }
        ...
        // ================= FOOTER =================
        const footerY = paymentSectionY + 100;
        ...
        doc.text(
            "2. Please verify measurements before delivery.",
            50,
            termY + 15
        );
